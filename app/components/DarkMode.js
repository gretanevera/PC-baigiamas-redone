...
export default function darkMode() {
  ...
  if ((document.body.style.backgroundImage === `linear-gradient(rgba(0, 0, 0, 0.9), rgba(0, 0, 0, 0.9)), url("${Image}")`)
    && (document.body.style.color = 'white') )
  {
    ...
    document.body.style.backgroundImage = `linear-gradient(rgba(0, 0, 0, 0.9), rgba(0, 0, 0, 0.9)), url("${Image}")`;
    document.body.style.color = 'white';
